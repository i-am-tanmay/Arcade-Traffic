Shader "CUSTOM/ToonCar"
{
    Properties
    {
        ...
        _Detail("Bands", Range(2,10)) = 2
        _DarkestBlacks("Darkest", Range(0,1)) = 0
...
#define THRESHBYCOL 0.0302734375
            ...
            float Toon(float3 normal, float3 lightDir)
            {
                ...
                return max(_DarkestBlacks, floor(NdotL * _Detail) / _Detail);
            }
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                col *= Toon(input.normal, mainLight.direction);
